...
class Controller_archivero_reportescontrato extends Controller_archivero_index {
    ...
    public function action_index() {
        if (isset($_POST['submit'])) {
            ...
            //var_dump($result);
            $this->template->content = View::factory('archivero/reportes/resulcontrato')
                    ->bind('result', $result);
        
        } else {
            $gestiones = ORM::factory('gestiones')->find_all();
            $users = ORM::factory('users')->find_all();
            $this->template->content = View::factory('archivero/reportes/vistacontrato')
