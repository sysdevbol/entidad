...
class Controller_archivero_reportesinventario extends Controller_archivero_index {
    ...
    public function action_index() {
        if (isset($_POST['submit'])) {
            ...
            //var_dump($result);
            $this->template->content = View::factory('archivero/reportes/resultinventario')
                    ->bind('result', $result);
        
        } else {
            $unidades0 = ORM::factory('unidades0')->find_all();
            $users = ORM::factory('users')->find_all();
            $this->template->content = View::factory('archivero/reportes/vistainventario')
