...
class Controller_archivero_reportesmodalidad extends Controller_archivero_index {
    ...
    public function action_index() {
        if (isset($_POST['submit'])) {
            ...
            $result = $gestiones->reporteFecha($_POST['modalidades'], $fecha1, $fecha2);
            $_POST['fecha1']=$fecha1;
            $_POST['fecha2']=$fecha2;
            //var_dump($result);
            $this->template->content = View::factory('archivero/reportes/result30')
                    ->bind('post', $_POST)
                    ->bind('result', $result);
            ...
            $this->template->content = View::factory('archivero/reportes/vistamodalidad')
