...
<form class="form-horizontal" method="post" action="" name="basic_validate" id="basic_validate" novalidate="novalidate" >
  ...
  <header>
    <h2>Formulario de Registro Proveedores.</h2>
    <div>Inicialmente llene de forma correcta cada dato solicitado. Finalizado el registro el Sistema le enviara un correo de notificacion a la Direccion que usted Registre. Con esa notificacion usted tendra
    que completar los datos que el sistema le solicite una vez ingresando al sistema de registro de Empresas. </div> 
  </header>
  <div class="titgrupo">
  <?php echo 'DATOS GENERALES DEL PROPONENTE'?>
  </div>
  <div class="control-group">
    <label class="desc" id="title1" for="Field1"><?php echo 'Nombre del Proponente:'?></label>
    <div>
 ...
 <div class="control-group">
      ...
      <textarea id="direccion" name="direccion" spellcheck="true" rows="1" cols="50" tabindex="4" class="required"></textarea>
        ...
        <div class="control-group">
        <label class="desc" id="title1" for="Field1"><?php echo 'Número de Identificacion Tributaria :'?></label>  
                              <div>
  ...
  <div class="control-group">
      ...
      <div>
            <?php echo Form::input('paterno_representante',$datosE['paterno_representante'],array('id'=>'paterno_representante','class' => 'field text fn ')); ?>
      </div>
  </div>
  ...
  <div>
        ...
        <?php echo Form::input('materno_representante',$datosE['materno_representante'],array('id'=>'materno_representante','class' => 'field text fn ')); ?>
  </div>
  </div>
  <div class="control-group">
  ...
  <div class="control-group">
                          ...
                          <div>
                                <?php echo Form::input('testimonio',$datosE['testimonio'],array('id'=>'testimonio','class' => 'field text fn ')); ?>
                          </div>
                          </div>
                          <div class="control-group">
                          <label class="desc" id="title1" for="Field1"><?php echo 'Lugar de Emisión:'?></label>
                          <div>
                                <textarea id="testimonio_emision" name="testimonio_emision" spellcheck="true" rows="2" cols="50" tabindex="4" class=""><?php echo $datosE['testimonio_emision'];?></textarea>
                          </div>
                          </div>
                          <div class="control-group">
                          <label class="desc" id="title1" for="Field1"><?php echo 'Fecha de Expedición de Testimonio:'?></label>
                            <div>
                                <?php echo Form::input('testimonio_fecha_expedido',NULL,array('id'=>'testimonio_fecha_expedido','class' => 'field text fn date ')); ?>
                            </div>
                          </div>
  ...
  <div>
        <?php echo Form::input('fax',$datosE['fax'],array('id'=>'fax','class' => 'field text fn ')); ?>
  </div>
  </div>
  <div class="control-group">
  <label class="desc" id="title1" for="Field1"><?php echo 'Número de Telefono:'?></label>
  <div>
        <?php echo Form::input('telefonos',$datosE['telefonos'],array('id'=>'telefonos','class' => 'field text fn ')); ?>
  </div>
  </div>
  <div class="control-group">
  ...
  <div>
        <?php echo Form::input('mail',$datosE['mail'],array('id'=>'mail','class' => 'field text fn required email')); ?>
  </div>
  </div>
  <div class="control-group">
