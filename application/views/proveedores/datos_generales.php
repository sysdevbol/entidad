 ...
 <div class="control-group">
  ...
  <div class="control-group">
                          ...
                          <label class="desc" id="title1" for="Field1"><?php echo 'Fecha de Expedición de Testimonio:'?></label>
                            <div>
                                <?php echo Form::input('testimonio_fecha_expedido',date::dateformat($datosE['testimonio_fecha_expedido']),array('id'=>'testimonio_fecha_expedido','class' => 'field text fn date ')); ?>
                            </div>
                          </div>
