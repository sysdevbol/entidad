...
<form class="form-horizontal" method="post" action="" name="basic_validate" id="basic_validate" novalidate="novalidate" >
  ...
  <div class="control-group">
    <label class="desc" id="title1" for="Field1"><?php echo 'Nombre de la FUNDACION:'?></label>
    <div>
  ...
  <div class="titgrupo">
  <?php echo 'DOCUMENTACIÓN DE LA FUNDACION'?>
  </div>
  <div class="control-group">
      <div>
      <label class="desc" id="" for=""><?php echo 'EN ESTE CUADRO INGRESE DETALLADAMENTE LOS SIGUIENTES DOCUMENTOS:'?></label>
      </div>
  </div>
  <div class="control-group">
    <label class="desc" id="title1" for="Field1"><?php echo "Acta de Fundación;\nEstatutos;\nReglamento Interno;\nResolucion Suprema que Aprueba su personalidad Jurídica"?></label>
    <div>
      <textarea id="otros_documentos" name="otros_documentos" spellcheck="true" rows="5" cols="50" tabindex="4" class="required"><?php echo $datosE['otros_documentos'];?></textarea>
    </div>
  </div>
