...
<form class="form-horizontal" method="post" action="" name="basic_validate" id="basic_validate" novalidate="novalidate" >
  ...
  <div class="control-group">
    <label class="desc" id="title1" for="Field1"><?php echo utf8_encode('Nombre de la FUNDACION:')?></label>
    <div>
  ...
  <div class="titgrupo">
  <?php echo utf8_encode('DOCUMENTACIÓN DE LA FUNDACION')?>
  </div>
  <div class="control-group">
      <div>
      <label class="desc" id="" for=""><?php echo utf8_encode('EN ESTE CUADRO INGRESE DETALLADAMENTE LOS SIGUIENTES DOCUMENTOS:')?></label>
      </div>
  </div>
  <div class="control-group">
    <label class="desc" id="title1" for="Field1"><?php echo utf8_encode("Acta de Fundación;\nEstatutos;\nReglamento Interno;\nResolucion Suprema que Aprueba su personalidad Jurídica")?></label>
    <div>
      <textarea id="otros_documentos" name="otros_documentos" spellcheck="true" rows="5" cols="50" tabindex="4" class=""></textarea>
    </div>
  </div>
