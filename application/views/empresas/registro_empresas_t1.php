...
<form class="form-horizontal" method="post" action="" name="basic_validate" id="basic_validate" novalidate="novalidate" >
  ...
  <div class="control-group">
    <label class="desc" id="title1" for="Field1"><?php echo utf8_encode('Nombre del proponente o Razón Social:')?></label>
    <div>
  ...
  <div class="control-group">
      <label class="desc" id="title1" for="Field1"><?php echo utf8_encode('Dirección:')?></label>
      <div>       
  ...
  <div class="control-group">     
  <label class="desc" id="title1" for="Field1"><?php echo utf8_encode('Fecha de Expedición del NIT :')?></label>
  <div>
 ...
 <div class="control-group">
  <label class="desc" id="title1" for="Field1"><?php echo utf8_encode('Número de Matricula :')?></label>
    <div>
  ...
  <div class="control-group">
  <label class="desc" id="title1" for="Field1"><?php echo utf8_encode('Fecha de Expedición de la Matricula:')?></label>
    <div>
  ...
  <div class="titgrupo">
  <?php echo utf8_encode('INFORMACIÓN SOBRE NOTIFICACIONES/COMUNICACIONES(Toda la Información legal sera remitida a las siguientes direcciones)')?>
  </div>
  <div class="control-group">
  <label class="desc" id="title1" for="Field1"><?php echo utf8_encode('Número de Fax:')?></label>
  <div>
        <?php echo Form::input('fax',NULL,array('id'=>'fax','class' => 'field text fn ')); ?>
  </div>
  </div>
  <div class="control-group">
  <label class="desc" id="title1" for="Field1"><?php echo utf8_encode('Número de Telefono:')?></label>
  <div>
        <?php echo Form::input('telefonos',NULL,array('id'=>'telefonos','class' => 'field text fn ')); ?>
  </div>
  </div>
  <div class="control-group">
  <label class="desc" id="title1" for="Field1"><?php echo utf8_encode('Número de Celular:')?></label>
  <div>
  ...
  <div class="control-group">
  <label class="desc" id="title1" for="Field1"><?php echo utf8_encode('Correo Electrónico Alternativo:')?></label>
  <div>
