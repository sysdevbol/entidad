...
<form class="form-horizontal" method="post" action="" name="basic_validate" id="basic_validate" novalidate="novalidate" >
  ...
  <div class="control-group">
    <label class="desc" id="title1" for="Field1"><?php echo 'Nombre del Profesional Independiente:'?></label>
    <div>
  ...
  <div class="control-group">
    <label class="desc" id="title1" for="Field1"><?php echo 'Número de C.I/NIT :'?></label>  
      <div>
  ...
  <div class="control-group">
      <label class="desc" id="title1" for="Field1"><?php echo 'Dirección del Representante:'?></label>
      <div>       
      <textarea id="direccion_representante" name="direccion_representante" spellcheck="true" rows="1" cols="50" tabindex="4" class="required"><?php echo $datosE['direccion_representante'];?></textarea>
      </div>
  </div>
