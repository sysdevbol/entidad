  ...
  <div class="col-lg-12">
    <div class="form-panel">
      ...
      <form class="form-horizontal" method="post" action="" name="basic_validate" id="basic_validate" novalidate="novalidate" >
        ...
        $ocursoarray = new Model_Cursocortoconsultor();
        $result = $ocursoarray->listaprcursocorto($idconsultor);
        foreach ($result as $key => $value) {
        if(!empty($_GET['idupdate']) and $value['id'] == $_GET['idupdate']){
        ?>
        <tr>
        <td>
        <?php echo Form::input('curso_corto1',$value['curso_corto'],array('id'=>'curso_corto1','class' => 'field text fn required')); ?>
        </td>
        <td>

        <input type="radio" id="carga_horaria1" name="carga_horaria1" value="Menos de 20 Hrs" checked /> Menos de 20 Hrs
        <input type="radio" id="carga_horaria1" name="carga_horaria1" value="Mas de 20 Hrs" /> Mas de 20 Hrs
        ...
        <td>
        <input type="hidden" name="idcurso" id="idcurso" value="<?php echo $_GET['idupdate']; ?>"/>
        ...
        <input type="radio" name="ideliminacurso" id="ideliminacurso" value="<?php echo $value['id']; ?>">
