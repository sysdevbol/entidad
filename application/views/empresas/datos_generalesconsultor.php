...
<div class="row mt">
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal" method="post" action="" name="basic_validate" id="basic_validate" novalidate="novalidate" >
                          ...
                          <div class="titgrupo">
                          <?php echo 'DATOS GENERALES DEL CONSULTOR'?>
                          </div>
                          ...
                          <div>
                                ...
                                <?php echo Form::input('nombre_completo',$datosC['nombre_completo'],array('id'=>'nombre_completo','class' => 'field text fn required')); ?>
                          </div>
                          </div>
                          <div class="control-group">
                          <label class="desc" id="" for=""><?php echo utf8_encode('Cedula de Identidad:')?></label>
                          <div>
                                <?php echo Form::input('ci',$datosC['ci'],array('id'=>'ci','class' => 'field text fn required')); ?>
                                
                                <label class="desc" id="" for=""><?php echo utf8_encode('Expedido en:')?></label>
                                <?php echo Form::select('ci_exp', $ciudades, $datosC['ci_exp'], array('id'=>'ci_exp','class' => 'field medium required')); ?>
                          </div>
                          </div>
                          <div class="control-group">     
                          <?php
                          $fechana = $datosC['fecha_nacimiento'];
                          ...
                          <div>
                                <?php echo Form::input('fecha_nacimiento',$fechana,array('id'=>'fecha_nacimiento','class' => 'field text fn required date')); ?>
                            </div>
                          </div>
                          <div class="control-group">
                          ...
                          <div>
                                ...
                                <?php echo Form::input('procedencia',$datosC['procedencia'],array('id'=>'procedencia','class' => 'field text fn required')); ?>
                          </div>
                          </div>
                          <div class="control-group">
                          <label class="desc" id="title1" for="Field1"><?php echo utf8_encode('Sexo:')?></label>
                          <div>
                                <input type="radio" id="sexo" name="sexo" value="M" <?php if($datosC['sexo'] == "M"){ echo "checked"; }  ?> /> Masculino
                                <input type="radio" id="sexo" name="sexo" value="F" <?php if($datosC['sexo'] == "F"){ echo "checked"; }  ?> /> Femenino
                          </div>
                          </div>
                          <div class="control-group">
                          ...
                          <div>
                                ...
                                <?php echo Form::input('profesion',$datosC['profesion'],array('id'=>'profesion','class' => 'field text fn required')); ?>
                          </div>
                          </div>
                          <div class="control-group">
                          ...
                          <div>
                                ...
                                <?php echo Form::input('telefonos',$datosC['telefonos'],array('id'=>'telefonos','class' => 'field text fn required')); ?>
                          </div>
                          </div>
                          <div class="control-group">
                          ...
                          <div>
                                ...
                                <?php echo Form::input('celular',$datosC['celular'],array('id'=>'celular','class' => 'field text fn required')); ?>
                          </div>
                          </div>
                          <div class="control-group">
                          <label class="desc" id="title1" for="Field1"><?php echo utf8_encode('Correo Electronico:')?></label>
                          <div>
                                <label class="desc" id="title1" for="Field1"><?php echo utf8_encode($datosC['mail'])?></label>
                                
                          </div>
                          </div>
                          <div style="text-align: center;">
                          <?php echo Form::hidden('id',$datosC['id'],array('id'=>'id','class' => 'field text fn')); ?>
