...
<form class="form-horizontal" method="post" action="" name="basic_validate" id="basic_validate" novalidate="novalidate" >
  <header>
    <h2>Formulario de Actualización (Asociacion Accidental)</h2>
  ...
  <div class="control-group">
    <label class="desc" id="title1" for="Field1"><?php echo 'Denominación de la Asociación Accidental:'?></label>
    <div>
  ...
  <div class="control-group">
      <div>
      <label class="desc" id="title1" for="Field1"><?php echo 'TESTIMONIO DE CONSTITUCION'?></label>
      </div>
  </div>
  <div class="control-group">
